...
from routes import reminders as reminder_routes, templates as template_routes, shared as shared_routes, push as push_routes
...
def _register_jobs():
    """wire the periodic checks into the shared job registry — scheduled reminders/
    messages + keeping the provider model lists fresh. extensible for new jobs."""
...
class TokenAuthMiddleware:
    ...
    1. Bearer aide_xxx or aide_xxx token -> validate it.
